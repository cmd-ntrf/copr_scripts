...
patch_version="1.0.0"
patch_zip_filename="v${patch_version}.zip"
curl -L -O https://github.com/MagicCastle/slurm-select-cons_tres_cloud/archive/refs/tags/${patch_zip_filename}
