...
TAG=$(curl -s -N https://api.github.com/repos/schedmd/slurm/tags | jq -r '.[].name' | grep -m 1 slurm-25-05)
...
tar xf slurm-25.05-latest.tar.bz2
rm slurm-25.05-latest.tar.bz2
cd slurm-${TARNAME}*
autoconf
aclocal
automake
